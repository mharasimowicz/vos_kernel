...
// static kernel_symbol_t irq_kernel_symbols[IRQ_CHAIN_SIZE];

// void irq_install(void) {
// 	//char buffer[16];
// 	kernel_symbol_t* k = (kernel_symbol_t *) irq_kernel_symbols;
// 	for (int i = 0; i < IRQ_CHAIN_SIZE; i++) {
// 		//sprintf(buffer, "_irq%d", i);
// 		irqs[i] = k + sizeof(kernel_symbol_t) * i; // symbol_find(buffer);
// 	}
// 	irq_remap();
// 	irq_setup_gates();
// }
